 ...
 */
export class TrackingPopup extends dnd5e.applications.actor.BaseConfigSheetV2 {
  constructor(options) {
    foundry.utils.mergeObject(options ?? {}, {
      ...
      closeOnSubmit: false,
      actions: {
        deleteRecovery: TrackingPopup._deleteRecovery,
        addRecovery: TrackingPopup._addRecovery,
      },
    });
    super(options);
  }
  ...
  static PARTS = {
    config: {
      template: "modules/ak5e/templates/tracking_bar_popup_config.hbs",
      templates: ["modules/ak5e/templates/tracking_bar_config.hbs"],
    }
  };
  ...
  async _preparePartContext(partId, context, options) {
    ...
    context.flags.ak5e = this.document.flags?.ak5e ?? TRACKING_BARS_DEFAULT;
    ...
    context.animations = TRACKING_BARS_DEFAULT.animations;
